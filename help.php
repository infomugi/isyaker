<!-- Require the header -->
<!DOCTYPE html>
<html style="min-height: 617px;" lang="en"><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<meta charset="utf-8">
<script type="text/javascript" src="Help/jquery.js"></script>
<title>Managemen Project - Help</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="">
<meta name="author" content="Mugi Rachmat - infomugi@gmail.com">


<link href="Help/bootstrap.css" rel="stylesheet" type="text/css">
<link href="Help/font-awesome.css" rel="stylesheet" type="text/css">
<link href="Help/ionicons.css" rel="stylesheet" type="text/css">
<link href="Help/AdminLTE.css" rel="stylesheet" type="text/css">
...
<link rel="shortcut icon" href="http://localhost/project_dokterdesain/themes/adminlte/img/logo.png">

</head>

<body style="min-height: 617px;" class=" fixed skin-black pace-done">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="form-search">
            <div class="input-group">
                <form method="GET">
                    <input name="q" class="form-control" placeholder="Search..." autocomplete="off" type="text">
                </form>
            </div>
        </div>
        ...
        <div class="navbar-right">
            ...
            <ul class="nav navbar-nav" id="yw0">
                <li><a href="http://localhost/project_dokterdesain/index.php?r=site/index"><i class="fa fa-home"></i> Home</a></li>
                <li><a href="http://localhost/project_dokterdesain/index.php?r=project/index"><i class="fa fa-archive"></i> Project</a></li>
                <li><a href="http://localhost/project_dokterdesain/index.php?r=site/logout"><i class="fa fa-power-off"></i> Logout</a></li>
            </ul>
            <!-- END: MENU ATAS -->
...
<div style="min-height: 617px;" class="wrapper row-offcanvas row-offcanvas-left">
    <!-- Left side column. contains the logo and sidebar -->
    <aside style="min-height: 617px;" class="left-side sidebar-offcanvas">                
        <!-- sidebar: style can be found in sidebar.less -->
        <div style="position: relative; overflow: hidden; width: auto; height: 617px;" class="slimScrollDiv">
        <section style="overflow: hidden; width: auto; height: 617px;" class="sidebar">

        <div class="user-panel datebar" style="text-align:left;">
            <a href="#" class="btn btn-block btn-flat btn-info"> <b>Back to Home</b> </a>
        </div>
            ...
            <ul style="display: block;" class="treeview-menu">
                <li><a href="#introduce" data-toggle="collapse" data-parent="#accordion">Pengenalan</a></li>
                <li><a href="#kebutuhan" data-toggle="collapse" data-parent="#accordion">Kebutuhan</a></li>          
                <li><a href="#instalasi" data-toggle="collapse" data-parent="#accordion">Instalasi</a></li>
            </ul>
            </li>
            ...
            <li class="treeview">  
                ...
                <li><a href="#login" data-toggle="collapse" data-parent="#accordion">Login</a></li>
                <li><a href="#dashboard" data-toggle="collapse" data-parent="#accordion">Dashboard</a></li>          
                </ul>
            </li>
            ...
            <li class="treeview">  
                <a href="#">Project</a>                
                <ul class="treeview-menu">
                <li><a href="#add_project" data-toggle="collapse" data-parent="#accordion">Tambah Data Project</a></li> 
                <li><a href="#list_project" data-toggle="collapse" data-parent="#accordion">Melihat Data Project</a></li>
                <li><a href="#manage_project" data-toggle="collapse" data-parent="#accordion">Mengelola Data Project</a></li> 
                <li><a href="#view_project" data-toggle="collapse" data-parent="#accordion">Detail Data Project</a></li> 
                </ul>
            </li>
            ...
            <li class="treeview">  
                <a href="#">Customer</a>                
                <ul class="treeview-menu">
                <li><a href="#add_customer" data-toggle="collapse" data-parent="#accordion">Tambah Data Customer</a></li> 
                <li><a href="#list_customer" data-toggle="collapse" data-parent="#accordion">Melihat Data Customer</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">  
                <a href="#">Invoice</a>                
                <ul class="treeview-menu">
                <li><a href="#add_invoice" data-toggle="collapse" data-parent="#accordion">Membuat Invoice</a></li> 
                <li><a href="#view_invoice" data-toggle="collapse" data-parent="#accordion">Melihat Data Invoice</a></li>
                <li><a href="#print_invoice" data-toggle="collapse" data-parent="#accordion">Print Invoice</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">  
                <a href="#">Report</a>                
                <ul class="treeview-menu">
                <li><a href="#export_report" data-toggle="collapse" data-parent="#accordion">Mencetak Laporan</a></li> 
                </ul>
            </li>
...
<h1>Managemen Project - Help</h1>
<div class="breadcrumb">
<a href="#">Dashboard</a> » <span>Help</span></div><!-- breadcrumbs -->
</section>
...
<!-- Require the footer -->
<!-- Bootstrap -->
<script src="Help/bootstrap.js" type="text/javascript"></script>

<!-- Bootstrap -->
<script src="Help/animate.css" type="text/javascript"></script>

<!-- AdminLTE App -->
<script src="Help/app.js" type="text/javascript"></script>

<!-- AdminLTE App -->
<script src="Help/app.htm" type="text/javascript"></script>
